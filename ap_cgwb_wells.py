# -*- coding: utf-8 -*-
"""
Created on Thu Mar 18 15:45:21 2021
...
# get data file names
path =r'E:\Objective_1\objective_1-20201119T105917Z-003\objective_1\cgwb\ap'
...
#    
#well.to_excel('E:\\Objective_1\\objective_1-20201119T105917Z-003\\objective_1\\cgwb\\ap\\ap_wells.xlsx')   
#well_grp=well.groupby('LAT')['WLCODE'].nunique()
#well_ind = well.drop_duplicates('WLCODE')
#well_loc=well_ind[['LAT','LON','WLCODE']]   
#well_loc.to_excel('E:\\Objective_1\\objective_1-20201119T105917Z-003\\objective_1\\cgwb\\ap\\ap_wells_locations.xlsx')
